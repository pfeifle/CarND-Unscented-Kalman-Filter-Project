...
UKF::UKF() {
  ...
  P_ = MatrixXd(5, 5);
  // use initialization from udacity 7.15
 ...
 if (!is_initialized_) {
    ...
    if (meas_package.sensor_type_ == MeasurementPackage::RADAR) {
      ...
      */
      ...
      x_ << x_radar_init, y_radar_init, ro_dot,0,0;
    }
...
void UKF::Prediction(double delta_t) {
  ...
  *******************************************************************************/
  ...
  for (int i = 0; i< 2*n_aug_+1; i++)
  {
    ...
    if (fabs(p_x) < 0.001) p_x = 0.001;
    if (fabs(p_y) < 0.001) p_y = 0.001;
  ...
  ******************************************************************************/
  ...
  Xsig_pred_ = Xsig_pred; // save the state
} // Predict
...
/*******************************************************************************
    ...
    ******************************************************************************/    
    ...
    if (fabs(z[0]) < 0.001) z[0] = 0.001;
    if (fabs(z[1]) < 0.001) z[1] = 0.001;
